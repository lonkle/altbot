...
module.exports = {
	...
	execute(message, args) {
		message.channel.send("Fetching status... <a:loading:718190657579253782>")
			.then(msg => {
				webshot.fromURL("https://www.apple.com/support/systemstatus/", "status.jpeg", { screenSize: { width: 1920, height: 1080 }, shotSize: { width: 990, height: 810 }, shotOffset: { left: 464, top: 98 } }, function () {
